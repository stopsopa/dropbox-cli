...
function green {
    ...
    if [ "$1" = "--dev" ]; then
        ...
        green "package.json -> package_prod.json  and  package_dev.json -> package.json [done]"
    ...
    if [ "$1" = "--prod" ]; then
        ...
        green "package.json -> package_dev.json  and  package_prod.json -> package.json [done]"
